...
class OltHelper
{
    ...
    private static function addVsolOnu($oltConnector, $onuId, $serialNumber, $params)
    {
        ...
        $oltConnector->executeCommand("onu $onuId pri username admin_control enable admin {$params['admin_password']} user_control enable user {$params['client_password']}", false);
