...
class OltHelper
{
    ...
    private static function addVsolOnu($oltConnector, $onuId, $serialNumber, $params)
    {
        ...
        $oltConnector->executeCommand("onu $onuId pri tr069_mng disable", false);
        $oltConnector->executeCommand("onu $onuId pri username admin_control disable admin {$params['admin_password']} user_control disable user {$params['client_password']}", false);
